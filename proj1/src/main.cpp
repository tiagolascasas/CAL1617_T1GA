...
int main(int argc, char** argv)
{
	if (argc != ARGS && argc != NO_ARGS)
	{
		...
		cout << "Usage: proj1 nodes_file road_nodes_file road_file markets_file\n";
		cout << "       or simply proj1 to use the default file names\n";
		return 1;
	}
	...
	try
	{
		...
		{
			char* filenames[] = { "", "res/nodes.txt", "res/road_nodes.txt",
